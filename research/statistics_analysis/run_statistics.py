...
# Združimo rezultate v en DataFrame
df_results = pd.concat(all_results, ignore_index=True)

# Skupinska analiza po metodi
...
# 1️⃣ Histogram - porazdelitev števila skupnosti po metodah
...
# 1️⃣ Histogram - največja skupnost
plt.figure(figsize=(12, 6))
...
# 2️⃣ Boxplot - modularnost po metodah
plt.figure(figsize=(12, 6))
...
# 3️⃣ Violin plot - porazdelitev koeficienta gručenja po metodah
plt.figure(figsize=(12, 6))
